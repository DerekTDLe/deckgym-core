...
mod tests {
    ...
    fn test_all_abilities_covered() {
        use AbilityId::*;
        let all_abilities = [
            A1020VictreebelFragranceTrap, A1061PoliwrathCounterattack,
            A1089GreninjaWaterShuriken, A1098MagnetonVoltCharge,
            A1123GengarExShadowySpellbind, A1177Weezing, A1188PidgeotDriveOff,
            A1007Butterfree, A1132Gardevoir, A1a006SerperiorJungleTotem,
            A1a046AerodactylExPrimevalLaw, A1a019VaporeonWashOut,
            A2a010LeafeonExForestBreath, A2a050CrobatCunningLink, A2a071Arceus,
            A2022ShayminFragrantFlowerGarden, A2072DusknoirShadowVoid,
            A2078GiratinaLevitate, A2092LucarioFightingCoach,
            A2a069ShayminSkySupport, A2110DarkraiExNightmareAura,
            A2b035GiratinaExBrokenSpaceBellow, A3066OricoricSafeguard,
            A3122SolgaleoExRisingRoad, A3141KomalaComatose,
            A3a015LuxrayIntimidatingFang, A3a021ZeraoraThunderclapFlash,
            A3a027ShiinoticIlluminate, A3a042NihilegoMorePoison,
            A3a062CelesteelaUltraThrusters, A3b009FlareonExCombust,
            A3b034SylveonExHappyRibbon, A3b056EeveeExVeeveeVolve,
            A3b057SnorlaxExFullMouthManner, A4083EspeonExPsychicHealing,
            A4112UmbreonExDarkChase, A4a010EnteiExLegendaryPulse,
            A4a020SuicuneExLegendaryPulse, A4a022MiloticHealingRipples,
            A4a025RaikouExLegendaryPulse, A4a044DonphanExoskeleton,
            B1073GreninjaExShiftingStream, B1121IndeedeeExWatchOver,
            B1157HydreigonRoarInUnison, B1160DragalgeExPoisonPoint,
            B1184EeveeBoostedEvolution, B1172AegislashCursedMetal,
            B1177GoomyStickyMembrane, PA037CresseliaExLunarPlumage,
            B1a006AriadosTrapTerritory, B1a012CharmeleonIgnition,
            B1a018WartortleShellShield, B1a034ReuniclusInfiniteIncrease,
