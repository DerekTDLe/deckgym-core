...
pub fn get_supporter_effect_categories(card_id: CardId) -> &'static [SupporterEffectCategory] {
    ...
    match card_id {
        ...
        | CardId::A4b348Lillie
        | CardId::A4b349Lillie
        | CardId::A4b374Lillie => &[Heal, Supporter],
        ...
        | CardId::A4b335Giovanni => &[DamageBoost, Supporter],
        ...
        | CardId::A4b339Sabrina => &[Switch, Supporter],
        ...
        | CardId::A4b319ElectricalCord => &[Tool, Energy],
