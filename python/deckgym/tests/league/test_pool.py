...
class TestOpponentPool(unittest.TestCase):
    ...
    def test_eviction_candidates(self):
        # Pool size is 3
        o1 = {"wins": 10, "losses": 0, "draws": 0, "added_at_step": 100, "is_baseline": False} # Hardest (WR 11/12 ~ 91%)
        o2 = {"wins": 0, "losses": 10, "draws": 0, "added_at_step": 200, "is_baseline": False} # Easiest (WR 1/12 ~ 8%)
        o3 = {"wins": 5, "losses": 5, "draws": 0, "added_at_step": 300, "is_baseline": False} # Middle (WR 6/12 ~ 50%)
        b1 = {"wins": 10, "losses": 10, "draws": 0, "added_at_step": 50, "is_baseline": True}  # Baseline
    ...
    def test_eviction_tie_break_age(self):
        ...
        o1 = {"wins": 0, "losses": 0, "draws": 0, "added_at_step": 100, "is_baseline": False}
        o2 = {"wins": 0, "losses": 0, "draws": 0, "added_at_step": 50, "is_baseline": False}
